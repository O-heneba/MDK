      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-xl text-gold tracking-wider">MEDIKAL FANBASE</span>
            <span className="font-display text-xl text-foreground tracking-wider">BYK FAMILY</span>
          </div>
        ...
        <p className="text-center text-muted-foreground/50 text-xs mt-6">
          © {new Date().getFullYear()} Medikal Fanbase (BYK FAMILY). All rights reserved.
        </p>
      </div>
    </footer>
  );
